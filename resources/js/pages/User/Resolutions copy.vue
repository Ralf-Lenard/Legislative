        ...
        >
          <div class="flex-1 px-6 py-6 overflow-y-auto custom-scrollbar">
            ...
            <div class="flex flex-col gap-1 mt-2">
              ...
              <p
                v-if="selectedResolution.author_resolutions"
                class="text-sm text-gray-600"
              >
                Author:
                <strong>{{ selectedResolution.author_resolutions }}</strong>
              </p>
            </div>
...
// Same character rule used on the ordinance upload forms — only letters,
// numbers, spaces, hyphens and underscores survive, to avoid tripping a
// hosting-provider WAF/mod_security rule on the filename.
