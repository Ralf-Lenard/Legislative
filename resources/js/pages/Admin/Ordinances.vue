<script setup lang="ts">
    ...
    // Updated props to match your Controller
    const { props } = usePage<{
    ...
    // Computed values using Controller data
    const years = computed(() => props.years || []);
    const paginationMeta = computed(() => props.ordinances?.meta || null);
    const paginationLinks = computed(() => props.ordinances?.links || []);
    ...
    watch(
        () => props.ordinances?.data,
        (newData) => {
            if (newData) {
                ordinances.value = [...newData];
                nextTick(() => checkLineClamp());
            }
        }
    );
    ...
    <template>
        ...
        <div class="flex h-screen bg-slate-50">
            ...
            <main class="relative flex-1 overflow-auto">
                ...
                <div class="sticky top-0 z-2 border-b border-slate-200 bg-white shadow-md">
                ...
                <div class="grid grid-cols-1 gap-6 px-8 pt-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="flex items-center justify-between rounded-lg border-l-4 border-emerald-500 bg-white p-5 shadow-lg">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-slate-900">{{ props.totalOrdinances }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between rounded-lg border-l-4 border-sky-500 bg-white p-5 shadow-lg">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-slate-900">{{ props.latestYearOrdinancesCount }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between rounded-lg border-l-4 border-indigo-500 bg-white p-5 shadow-lg">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-slate-900">{{ props.ordinancesWithPdfCount }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between rounded-lg border-l-4 border-purple-500 bg-white p-5 shadow-lg">
                        <div>
                            ...
                            <p class="mt-2 text-3xl font-bold text-slate-900">{{ props.ordinancesWithImageCount }}</p>
                        </div>
                ...
                <div class="p-8">
                    <div class="overflow-hidden rounded-lg border border-slate-100 bg-white shadow-lg">
                        <div v-if="!ordinances || ordinances.length === 0" class="py-16">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="mt-1 text-sm text-slate-500">Try adjusting your filters or create a new ordinance.</p>
                            </div>
                        </div>
                        ...
                        <table v-else class="w-full divide-y divide-slate-200">
                            ...
                            <tbody class="divide-y divide-slate-200">
                                <tr v-for="(ordinance, index) in ordinances" :key="ordinance.id" class="transition-colors hover:bg-emerald-50/50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div v-if="ordinance.image_ordinances">
                                            <button @click="openImageViewer(ordinance.image_ordinances)" class="overflow-hidden rounded-md border border-slate-300 p-0 shadow-sm transition-all hover:border-emerald-500 hover:shadow-md">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button @click="openViewModal(ordinance)" class="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 shadow-sm transition-all hover:bg-emerald-100">
                                                <Eye class="h-4 w-4"/>
                                            </button>
