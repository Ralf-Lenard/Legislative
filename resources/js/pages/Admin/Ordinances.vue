...
// <CHANGE> Remove client-side filtering - search is now handled by backend
...
// <CHANGE> Fixed: Added page: 1 to reset to first page when searching
const applyFilters = () => {
    router.get(
        '/admin-ordinances',
...
// <CHANGE> Added clearFilters function
const clearFilters = () => {
    search.value = '';
    year.value = '';
    router.get(
        ...
        <main class="relative flex-1 overflow-auto">
            ...
            <div class="grid grid-cols-1 gap-6 px-8 pt-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="flex items-center justify-between rounded-lg border-l-4 border-emerald-500 bg-white p-5 shadow-lg">
                    <div>
                        ...
                        <p class="mt-2 text-3xl font-bold text-slate-900">{{ paginationMeta?.total || ordinances.length }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between rounded-lg border-l-4 border-sky-500 bg-white p-5 shadow-lg">
                    <div>
                        ...
                        <p class="mt-2 text-3xl font-bold text-slate-900">{{ latestYearOrdinancesCount }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between rounded-lg border-l-4 border-indigo-500 bg-white p-5 shadow-lg">
                    <div>
                        ...
                        <p class="mt-2 text-3xl font-bold text-slate-900">{{ ordinancesWithPdfCount }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between rounded-lg border-l-4 border-purple-500 bg-white p-5 shadow-lg">
                    <div>
                        ...
                        <p class="mt-2 text-3xl font-bold text-slate-900">{{ ordinancesWithImageCount }}</p>
                    </div>
            ...
            <div class="p-8">
                <div class="overflow-hidden rounded-lg border border-slate-100 bg-white shadow-lg">
                        ...
                        <tbody class="divide-y divide-slate-200">
                            <tr v-for="(ordinance, index) in ordinances" :key="ordinance.id" class="transition-colors hover:bg-emerald-50/50">
                                <td class="px-6 py-4 text-sm font-medium text-slate-600">
                                    <!-- <CHANGE> Fixed row numbering for pagination -->
                                ...
                                <td class="px-6 py-4 text-sm text-slate-700">
                                    <div class="group relative">
                                        <p :ref="el => descRefs[ordinance.id] = el" :class="showFullDesc === ordinance.id ? '' : 'line-clamp-2'">
                    ...
                    <!-- Pagination -->
                    <!-- <CHANGE> Added proper null checks for pagination -->
