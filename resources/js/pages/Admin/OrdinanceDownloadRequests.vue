...
<template>
                    ...
                    <table v-else class="w-full divide-y divide-slate-200">
                        ...
                        <tbody class="divide-y divide-slate-200">
                            <tr v-for="(request, index) in requestsList" :key="request.id" class="hover:bg-emerald-50/50">
                                ...
                                <td class="px-6 py-4 text-sm font-medium">{{ request.user.name }}</td>
                                <td class="px-6 py-4 text-sm">{{ request.ordinance.title_ordinances }}</td>
    ...
    <div v-if="isApproveModalOpen" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl" @click.stop>
            ...
            <div class="flex justify-end gap-3">
                <button @click="isApproveModalOpen = false" class="rounded-lg bg-slate-100 px-4 py-2 text-slate-700">Cancel</button>
                <button @click="submitApproval" class="rounded-lg bg-emerald-600 px-4 py-2 font-semibold text-white">Yes, Approve</button>
            </div>
        </div>
    </div>
    ...
    <div v-if="isRejectModalOpen" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl" @click.stop>
            ...
            <textarea v-model="rejectionReason" rows="4" class="w-full rounded-lg border p-2 focus:ring-2 focus:ring-red-500" placeholder="Enter reason..."></textarea>
            <div class="mt-4 flex justify-end gap-3">
                <button @click="isRejectModalOpen = false" class="rounded-lg bg-slate-100 px-4 py-2">Cancel</button>
                <button @click="submitRejection" class="rounded-lg bg-red-600 px-4 py-2 font-semibold text-white">Reject</button>
            </div>
        </div>
    </div>
