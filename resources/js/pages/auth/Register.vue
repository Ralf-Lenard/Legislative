<script setup lang="ts">
    ...
    <template>
        ...
        <div class="h-svh w-full flex items-center justify-center bg-cover bg-center bg-no-repeat relative px-4 overflow-hidden"
            style="background-image: url('/images/lg.jpg')">
            
            <div class="absolute inset-0 bg-black/40 backdrop-blur-[2px]"></div>
    
            <div class="relative w-full max-w-[850px] backdrop-blur-xl bg-white/85 border border-white/40 shadow-2xl rounded-[1.5rem] md:rounded-[2rem] overflow-hidden flex flex-col max-h-[95vh]">
                    ...
                    <Form v-bind="store.form()" :reset-on-success="['password', 'password_confirmation']" v-slot="{ errors, processing }" class="flex flex-col gap-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <Input type="text" name="name" required placeholder="Juan Dela Cruz"
                                        class="bg-white/60 border-gray-200 h-10 pl-9 rounded-lg text-sm focus:ring-1 focus:ring-green-800" />
                                </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <Input :type="passwordType" name="password" required placeholder="••••••••"
                                        class="bg-white/60 border-gray-200 h-10 pl-9 pr-9 rounded-lg text-sm focus:ring-1 focus:ring-green-800" />
                                    <button type="button" @click="togglePasswordVisibility" class="absolute right-0 top-0 h-full w-9 flex items-center justify-center text-gray-400">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <Input :type="confirmPasswordType" name="password_confirmation" required placeholder="••••••••"
                                        class="bg-white/60 border-gray-200 h-10 pl-9 pr-9 rounded-lg text-sm focus:ring-1 focus:ring-green-800" />
                                    <button type="button" @click="toggleConfirmPasswordVisibility" class="absolute right-0 top-0 h-full w-9 flex items-center justify-center text-gray-400">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label for="terms" class="text-[11px] text-gray-600 cursor-pointer">
                                I agree to the <a href="/terms-of-service" class="text-green-900 font-bold">Terms of Service</a> and <a href="/privacy-policy" class="text-green-900 font-bold">Privacy Policy</a>.
                            </label>
                        </div>
    
                        <Button type="submit" class="w-full h-11 text-sm font-black tracking-widest bg-green-900 text-white hover:bg-[#FFCA52] hover:text-green-950 rounded-lg transition-all"
                        ...
                        <div class="text-center text-xs text-gray-600">
                            ...
                            <TextLink :href="login()" class="text-green-900 font-black hover:underline ml-1">Log in</TextLink>
                        </div>
                    </Form>
                </div>
