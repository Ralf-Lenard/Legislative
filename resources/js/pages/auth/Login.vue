            ...
            <div class="px-6 py-8 md:px-12 md:py-14 text-center">
                ...
                <div class="mb-6 md:mb-8">
                    ...
                    <p class="text-sm md:text-base text-gray-600 mt-2 font-medium">
                        Official Legislative Portal Access
                    </p>
                </div>

                <!-- Status -->
                <div v-if="status"
                    class="mb-6 p-3 text-xs md:text-sm text-green-700 bg-green-50/50 rounded-lg border border-green-300 backdrop-blur-sm">
                    {{ status }}
                </div>
                ...
                <Form v-bind="store.form()" :reset-on-success="['password']"
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 py-1">
                        ...
                        <label class="flex items-center gap-2 text-xs md:text-sm text-gray-700 font-semibold cursor-pointer">
                            <Checkbox name="remember"
                                class="h-4 w-4 border-gray-300 data-[state=checked]:bg-green-800 rounded-md"/>
                            Remember Me
                        </label>
                    ...
                    <!-- Submit -->
                    <Button type="submit"
                        class="w-full h-12 md:h-14 mt-2 md:mt-4 text-sm md:text-base font-black tracking-widest
                    ...
                    <div v-if="canRegister"
                        ...
                        <TextLink :href="register()"
                            class="text-green-900 font-black hover:underline ml-1">
                            Create Account
                        </TextLink>
                    </div>
