        ...
        <div class="flex items-center gap-3 cursor-pointer group" @click="goToHome">
         <div class="w-9 h-9 md:w-11 md:h-11 rounded-full overflow-hidden shadow-md group-hover:scale-105 transition-transform shrink-0">
          ...
          <div class="flex flex-col justify-center leading-tight">
            ...
            <p class="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-widest">
              Concepcion, Tarlac
            </p>
          </div>
        </div>
              ...
              <div class="relative hidden md:block">
                ...
                >
                  <div class="w-7 h-7 rounded-lg bg-[#ffc107] text-[#1b5e20] flex items-center justify-center border-2 border-white shrink-0 overflow-hidden text-xs">
                    ...
                    <span v-else class="font-black">{{ user.name.charAt(0).toUpperCase() }}</span>
                  </div>
                ...
                <transition enter-active-class="transition duration-100" enter-from-class="opacity-0 scale-95" enter-to-class="opacity-100 scale-100">
                  ...
                  >
                    ...
                    <div class="p-2">
                      <Link href="/profile" class="block px-3 py-2 text-sm text-gray-700 hover:bg-yellow-50 rounded-lg font-medium">
                        Profile Settings
                      </Link>
                      <Link
                        href="/document-requests"
                        class="block px-3 py-2 text-sm text-gray-700 hover:bg-yellow-50 rounded-lg font-medium"
                      >
                        My Requests
                      </Link>
                      <Link
      ...
      >
        <div class="px-4 py-6 space-y-1">
          ...
          <div class="pt-6 mt-4 border-t border-gray-100">
            ...
            <template v-if="user">
              <div class="flex items-center gap-3 px-5 py-2 mb-2">
                <div class="w-10 h-10 rounded-xl bg-[#ffc107] text-[#1b5e20] flex items-center justify-center font-black overflow-hidden shadow-sm">
                  <img v-if="profilePhotoUrl" :src="profilePhotoUrl" class="w-full h-full object-cover" />
